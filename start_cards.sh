...
do
  ...
  then
    ...
    ARGS[$ARGS_LENGTH]=-f
    ARGS_LENGTH=${ARGS_LENGTH}+1
    ARGS[$ARGS_LENGTH]=mvn:io.uhndata.cards/cards-modules-test-forms/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-email-notifications/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-patient-portal/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-clinician-dashboard/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-locking/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-jwt-token-authentication/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-chromosome/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-identifier/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-contact-info/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-dicom/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-selectable-area/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-vocabularies/${CARDS_VERSION}/slingosgifeature,mvn:io.uhndata.cards/cards-pedigree/${CARDS_VERSION}/slingosgifeature
    ARGS_LENGTH=${ARGS_LENGTH}+1
  elif [[ ${ARGS[$i]} == '--saml' ]]
  then
