...
INSERT INTO [path].[CL_EP_IP_EMAIL_CONSENT_IN_LAST_7_DAYS]
    ...
    VALUES
    (1234567, 'Alice', 'Smith', 'test@test.com', '2022-09-21T11:16:20.136Z', 'TG-EMERGENCY', 'Yes', CAST(GETDATE()-1 AS DATE));

INSERT INTO [path].[CL_EP_IP_EMAIL_CONSENT_IN_LAST_7_DAYS]
    (PAT_MRN, PAT_FIRST_NAME, PAT_LAST_NAME, EMAIL_ADDRESS, ENTRY_TIME, DISCH_DEPT_NAME, EMAIL_CONSENT_YN, LoadTime)
    VALUES
    (1234568, 'Bob', 'Smith', 'test2@test.com', '2022-09-21T11:16:20.136Z', 'TG-EMERGENCY', 'No', CAST(GETDATE()-1 AS DATE))

INSERT INTO [path].[CL_EP_IP_EMAIL_CONSENT_IN_LAST_7_DAYS]
    (PAT_MRN, PAT_FIRST_NAME, PAT_LAST_NAME, EMAIL_ADDRESS, ENTRY_TIME, DISCH_DEPT_NAME, EMAIL_CONSENT_YN, LoadTime)
    VALUES
    (1234568, 'Bob', 'Smith', 'test2@test.com', '2022-09-21T11:16:20.136Z', 'TW-EMERGENCY', 'No', CAST(GETDATE()-1 AS DATE))
