...
# Make the kernel version string safe for using as a command-line argument to another program
def sanitizeKernelVersion(version):
	clean_version = ""
...
# Get the running kernel version that is being used in this deployment
running_kernel_version = gh_client.readGitHubTextFile('hosts/' + args.deployment_hostname + '/vm/kernel_version').rstrip()

# The running kernel version should only consist of letters, numbers, '_', '-', '.'
print(sanitizeKernelVersion(running_kernel_version))
