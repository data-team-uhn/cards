...
downloadFile('docker/' + cards_image_hash_value + '/yarn.lock', os.path.join(args.download_dir, args.deployment_hostname, 'docker', 'cards', 'yarn.lock'), installation_token)
