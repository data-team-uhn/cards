...
gh_client = GitHubRepoHandler(cli_args=args, bot_username="github_download_yarn_packages_config.py")
...
# Get the yarn.lock file associated with the hash ID
gh_client.downloadGitHubFile('docker/' + cards_image_hash_value + '/yarn.lock', os.path.join(args.download_dir, args.deployment_hostname, 'docker', 'cards', 'yarn.lock'))
