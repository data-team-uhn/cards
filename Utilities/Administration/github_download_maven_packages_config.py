...
gh_client = GitHubRepoHandler(cli_args=args, bot_username="github_download_maven_packages_config.py")
...
# Get the maven.json file associated with the hash ID
gh_client.downloadGitHubFile('docker/' + cards_image_hash_value + '/maven.json', os.path.join(args.download_dir, args.deployment_hostname, 'docker', 'cards', 'maven.json'))
