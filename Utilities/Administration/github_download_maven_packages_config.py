...
downloadFile('docker/' + cards_image_hash_value + '/maven.json', os.path.join(args.download_dir, args.deployment_hostname, 'docker', 'cards', 'maven.json'), installation_token)
