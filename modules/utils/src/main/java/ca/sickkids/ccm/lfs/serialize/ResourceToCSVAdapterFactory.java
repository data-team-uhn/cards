...
/**
 * AdapterFactory that converts Apache Sling resources to CSV format. This is just a shell, the actual serialization is
 * provided by implementations of the {@link ResourceCSVProcessor} service.
 *
 * @version $Id$
 */
@Component(
    ...
    property = { "adaptables=org.apache.sling.api.resource.Resource",
        "adapters=ca.sickkids.ccm.lfs.serialize.CSVString" })
