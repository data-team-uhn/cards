...
/**
 * Unit tests for the default methods of {@link ResourceTextProcessor}.
 *
 * @version $Id$
 */
public class ResourceTextProcessorTest
{
    /** A processor relying on the default methods of the interface. */
    private final ResourceTextProcessor processor = new ResourceTextProcessor()
    {
        @Override
