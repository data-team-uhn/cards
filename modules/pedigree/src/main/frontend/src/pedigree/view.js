...
import { arrayContains, Timer } from './model/helpers';
import Partnership from './view/partnership';
import Person from './view/person';
import PersonGroup from './view/personGroup';
import LineSet from './view/lineSet';
import PedigreeEditorParameters from './pedigreeEditorParameters';
import { drawCornerCurve, drawLevelChangeCurve } from './view/graphicHelpers';
...
var View = Class.create({
  ...
  enterHoverMode: function(sourceNode, hoverType) {
    ...
    validTargets.forEach(function(nodeID) {
  ...
  exitHoverMode: function() {
    ...
    var me = this;
    this._currentGrownNodes.forEach(function(nodeID) {
      var node = me.getNode(nodeID);
