...
var PartnershipVisuals = Class.create(AbstractNodeVisuals, {
  ...
  getAllGraphics: function ($super) {
    return editor.getPaper().set(this.getHoverBox().getBackElements(), this._idLabel,
                                 this._childlessShape).concat($super()).push(this.getHoverBox().getFrontElements());
  },
...
PartnershipVisuals._p_addMethods(ChildlessBehaviorVisuals);
