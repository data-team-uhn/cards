...
public final class SearchUtils
{
        ...
        boolean isNoteMatch, String path)
    {
        ...
        builder.add(LFS_QUERY_MATCH_KEY, metadata);
    ...
    {
        JsonObjectBuilder builder = Json.createObjectBuilder();
        builder.add(LFS_QUERY_QUESTION_KEY, question);
        builder.add(LFS_QUERY_MATCH_NOTES_KEY, isNoteMatch);
        builder.add(LFS_QUERY_MATCH_PATH_KEY, path);
