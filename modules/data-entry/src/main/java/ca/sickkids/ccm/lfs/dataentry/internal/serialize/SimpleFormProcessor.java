...
public class SimpleFormProcessor implements ResourceJsonProcessor
{
        ...
        throws RepositoryException
    {
        ...
        if (!node.isNodeType("lfs:Form") && propertyName.startsWith("jcr:")
        ...
        throws RepositoryException
    {
        ...
        if (node.isNodeType("lfs:Subject") && "type".equals(propertyName)) {
        ...
        throws RepositoryException
    {
        ...
        if (node.isNodeType("lfs:Question") && !KEEP_QUESTION_PROPERTIES.contains(propertyName)) {
            return null;
        }
        return input;
    }
