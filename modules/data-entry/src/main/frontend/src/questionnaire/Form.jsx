...
function Form (props) {
  ...
  let [ formContentOffset, setFormContentOffset ] = useState(props.contentOffset);
  ...
  useEffect(() => {
    const height = document?.getElementById('cards-resource-header')?.clientHeight || 0;
    setFormContentOffset(contentOffset + height);
  }, [data, contentOffset])
