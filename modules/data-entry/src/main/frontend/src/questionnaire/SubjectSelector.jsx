...
function SubjectSelectorList(props) {
  ...
  let handleSelection = (rowData) => {
    let atMax = (relatedSubjects && selectedQuestionnaire && (relatedSubjects.filter((i) => (i["jcr:uuid"] == rowData["jcr:uuid"])).length >= (selectedQuestionnaire?.["maxPerSubject"] || undefined)))
    if (atMax) {
      ...
      <MaterialTable
        ...
        options={{
          ...
          rowStyle: rowData => ({
            ...
            color: ((relatedSubjects && selectedQuestionnaire && (relatedSubjects.filter((i) => (i["jcr:uuid"] == rowData["jcr:uuid"])).length >= (selectedQuestionnaire?.["maxPerSubject"] || undefined)))
