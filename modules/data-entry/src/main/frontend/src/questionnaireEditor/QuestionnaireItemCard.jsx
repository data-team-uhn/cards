...
const useStyles = makeStyles(theme => ({
  ...
  collapsed: {
    ...
    "& .MuiCardContent-root > .MuiGrid2-container > .MuiGrid2-root:last-child": {
  ...
  withAvatar: {
    ...
    "&.MuiCardContent-root > .MuiGrid2-container > .MuiGrid2-root": {
      paddingLeft: theme.spacing(5.5),
    },
    "&.MuiCardContent-root > .MuiGrid2-container > .MuiGrid2-root.cards-questionnaire-entry-props": {
