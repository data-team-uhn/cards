 ...
 * <p>
 * <code>
 * &lt;input data-sly-use.em="${'ca.sickkids.ccm.lfs.uix.ExtensionsManager' @ uixp='ExtensionPointName'}"
 ...
 * <p>
 * <code>
 *   &lt;ul data-sly-use.em="${'ca.sickkids.ccm.lfs.uix.ExtensionsManager' @ uixp='ExtensionPointName'}"&gt;
...
public class ExtensionsManager implements Use
{
    ...
    private void findExtensions(final String extensionPointId) throws RepositoryException
    {
        ...
        final Iterator<Resource> result = this.resourceResolver.findResources(
            "select n from [lfs:Extension] as n where n.'lfs:extensionPointId' = '" + extensionPointId + "'",
            "JCR-SQL2");
