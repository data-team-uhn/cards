...
public class VocabularyLabelProcessorTest
{
    ...
    {
        Assert.assertNotNull(this.vocabularyLabelProcessor.getDescription());
    }
    ...
    public void setupRepo() throws RepositoryException
    {
        ...
        try (Reader cnd = new InputStreamReader(
            getClass().getResourceAsStream("/SLING-INF/nodetypes/vocabularies.cnd"), StandardCharsets.UTF_8)) {
