 ...
 * </p>
 * <ul>
 * <li><tt>filter</tt>: a lucene search term, such as "david" or "adm*"</li>
 * <li><tt>offset</tt>: a 0-based number representing how many principals to skip</li>
 * <li><tt>limit</tt>: a number representing how many principals to include at most in the result</li>
 * </ul>
 *
 * @version $Id$
 */
