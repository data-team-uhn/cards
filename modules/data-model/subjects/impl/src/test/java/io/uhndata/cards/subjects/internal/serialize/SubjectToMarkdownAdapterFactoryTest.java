...
public class SubjectToMarkdownAdapterFactoryTest
{
    ...
    public void canProcessForSubjectReturnsTrue()
    {
        ...
        assertTrue(this.subjectToMarkdownAdapterFactory.canProcess(subject));
    }
    ...
    public void canProcessForSubjectTypeReturnsFalse()
    {
        ...
        assertFalse(this.subjectToMarkdownAdapterFactory.canProcess(subjectType));
    }

    @Test
    public void serializeForRootSubjectResource()
    {
        Resource subject = this.context.resourceResolver().getResource(TEST_SUBJECT_PATH);
        String markdown = this.subjectToMarkdownAdapterFactory.serialize(subject);
    ...
    @Test
    public void serializeForBranchSubjectResource()
    {
