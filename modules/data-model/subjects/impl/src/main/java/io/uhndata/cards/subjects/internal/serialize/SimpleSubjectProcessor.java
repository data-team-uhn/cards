...
/**
 * Simplify Subject serialization by removing unnecessary properties and children. The name of this processor is
 * {@code simple}.
 *
 * @version $Id$
 */
...
public class SimpleSubjectProcessor implements ResourceJsonProcessor
{
        ...
        throws RepositoryException
    {
        ...
        if (!node.isNodeType("cards:Subject") && propertyName.startsWith("jcr:")
