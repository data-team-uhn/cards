...
/**
 * Unit tests for {@link FormToMarkdownProcessor}.
 *
 * @version $Id$
 */
...
public class FormToMarkdownProcessorTest
{
    ...
    public void canProcessForFormReturnsTrue()
    {
        ...
        assertTrue(this.formToMarkdownProcessor.canProcess(form));
    }
    ...
    public void canProcessForQuestionnaireReturnsFalse()
    {
        ...
        assertFalse(this.formToMarkdownProcessor.canProcess(questionnaire));
    }

    @Test
    public void serializeForFormWithOneFooterAndOneDefaultSections()
    {
        Resource form = this.context.resourceResolver().getResource(TEST_FORM_PATH);
    ...
    @Test
    public void serializeForFormWithHeaderSection()
    {
        Resource form = this.context.resourceResolver().getResource("/Forms/f2");
    ...
    @Test
    public void serializeForFormWithRecurrentSection()
    {
        Resource form = this.context.resourceResolver().getResource("/Forms/f3");
    ...
    public void serializeForNullFormResource()
    {
        ...
        String markdown = this.formToMarkdownProcessor.serialize(originalResource);
        assertNull(markdown);
    }
