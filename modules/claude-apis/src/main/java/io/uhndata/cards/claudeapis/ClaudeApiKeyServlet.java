...
/**
 * A servlet that returns the current Claude API key.
 *
 * @version $Id$
 */
@Component(service = { Servlet.class },
    property = { "sling.auth.requirements=-/content.claudeApiKey", "sling.auth.requirements=-/.claudeApiKey" })
@SlingServletResourceTypes(
    resourceTypes = { "cards/Homepage" },
    methods = { "GET" },
    selectors = { "claudeApiKey" })
public class ClaudeApiKeyServlet extends SlingJakartaSafeMethodsServlet
{
    /**
     * The response from this service is a JSON object with this key holding the Claude API key as its value.
     */
    ...
    @Reference
    private ClaudeApiKeyManager apiKeyManager;
