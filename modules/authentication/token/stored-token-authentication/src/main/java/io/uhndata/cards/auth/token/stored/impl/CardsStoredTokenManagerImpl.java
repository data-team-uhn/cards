 ...
 */
@Component
public class CardsStoredTokenManagerImpl implements TokenManager
{
    private static final Logger LOGGER = LoggerFactory.getLogger(CardsStoredTokenManagerImpl.class);
