...
module.exports = {
  ...
  entry: {
    ...
    [module_name + 'Visit']: { 'import': './src/clinician-portal/Visit.jsx' },
    [module_name + 'Patient']: { 'import': './src/clinician-portal/Patient.jsx' },
    [module_name + 'Form']: { 'import': './src/clinician-portal/Form.jsx' },
