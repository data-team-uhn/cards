...
module.exports = {
  ...
  entry: {
    ...
    [module_name + 'FormView']: { 'dependOn': ['cards-dataentry.LiveTable'], 'import': './src/clinician-portal/FormView.jsx' },
    [module_name + 'SubjectView']: { 'dependOn': ['cards-dataentry.LiveTable'], 'import': './src/clinician-portal/SubjectView.jsx' },
    [module_name + 'Forms']: { 'dependOn': ['cards-login.loginDialogue'], 'import': './src/clinician-portal/Forms.jsx' },
    [module_name + 'Subjects']: { 'dependOn': ['cards-login.loginDialogue'], 'import': './src/clinician-portal/Subjects.jsx' },
