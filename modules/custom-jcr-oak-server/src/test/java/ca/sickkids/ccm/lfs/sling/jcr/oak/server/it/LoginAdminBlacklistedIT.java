...
/**
 * Test login admin without whitelisting the test bundle, so both variants of getting admin session should fail.
 */
...
public class LoginAdminBlacklistedIT extends OakServerTestSupport
{
    ...
    {
        this.repository.loginAdministrative(null).logout();
    }
    ...
    {
        this.resolverFactory.getAdministrativeResourceResolver(null).close();
    }
}
