...
public class OakSlingRepository extends AbstractSlingRepository2
{
    ...
    protected Session createAdministrativeSession(String workspace) throws RepositoryException
    {
        ...
        Set<? extends Principal> principals = Collections.singleton(new AdminPrincipal()
        {
            @Override
        ...
        Subject subject =
            new Subject(true, principals, Collections.singleton(authInfo), Collections.<Object>emptySet());
