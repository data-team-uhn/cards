...
/**
 * Factory for {@link AnswerRestrictionPattern}.
 *
 * @version $Id$
 */
@Component(immediate = true)
public class AnswerRestrictionFactory implements RestrictionFactory
{
    /** @see #getName */
    public static final String NAME = "lfs:answer";

    @Override
    public RestrictionPattern forValue(PropertyState value)
    {
        return new AnswerRestrictionPattern(value.getValue(Type.STRING));
    }
