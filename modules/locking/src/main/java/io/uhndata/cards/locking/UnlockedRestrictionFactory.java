...
public class UnlockedRestrictionFactory implements RestrictionFactory
{
    /** @see #getName */
    public static final String NAME = "cards:unlocked";
    ...
    public RestrictionPattern forValue(PropertyState value)
    {
        ...
        return new UnlockedRestrictionPattern(session);
    }
