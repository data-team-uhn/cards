...
public class UnlockRestrictionFactory implements RestrictionFactory
{
    /** @see #getName */
    public static final String NAME = "cards:unlock";
    ...
    public RestrictionPattern forValue(PropertyState value)
    {
        ...
        return new UnlockRestrictionPattern(session);
    }
