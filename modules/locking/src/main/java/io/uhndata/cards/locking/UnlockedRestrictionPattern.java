 ...
 * @version $Id$
 */
public class UnlockedRestrictionPattern extends LockedRestrictionPattern
{
     ...
     */
    public UnlockedRestrictionPattern(final Session session)
    {
        super(session);
    }
    ...
    {
        return !super.matches(tree, property);
    }
}
