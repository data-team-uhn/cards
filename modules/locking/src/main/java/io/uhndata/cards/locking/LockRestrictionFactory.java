...
public class LockRestrictionFactory implements RestrictionFactory
{
    /** @see #getName */
    public static final String NAME = "cards:lock";
    ...
    // Can't get an rrf or sling fails to start
    // @Reference
    ...
    public RestrictionPattern forValue(PropertyState value)
    {
        ...
        return new LockRestrictionPattern(session, null);
    }
